    ...
    <div className="shell">
      <aside className="sidebar">
        ...
        <nav className="snav">
          ...
          <a href="/notes" className="nb active"><span className="ni">📝</span>Visit Notes</a>
          <div className="ndiv"></div>
      ...
      <main className="main">
        ...
        <div className="content">
          <div className="view active" style={{padding:'40px 36px'}}>
            <div style={{fontFamily:"'Cormorant Garamond',serif",fontSize:32,fontWeight:700,color:'#2c1810',marginBottom:8}}>📝 Visit Notes</div>
            <div style={{fontSize:13,color:'#8a5c3c',marginBottom:28,lineHeight:1.6}}>
              Full Visit Notes functionality is being connected. Use the prototype for now.
            </div>
