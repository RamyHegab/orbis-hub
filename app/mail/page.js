    ...
    <div className="shell">
      ...
      <main className="main">
        <div className="topbar">
          <div className="tb-bc"><span className="bc-cur">Mailing</span></div>
        ...
        <div className="content">
          <div className="view active" style={{{{padding:'32px 36px'}}}}>
            <div style={{{{fontFamily:"'Cormorant Garamond',serif",fontSize:28,fontWeight:700,color:'#2c1810',marginBottom:8}}}}>Mailing</div>
            <div style={{{{fontSize:13,color:'#8a5c3c',marginBottom:24}}}}>Full Mailing interface coming soon.</div>
            <div style={{{{padding:'16px 20px',background:'#e6f4f1',border:'1px solid #4db89e',borderRadius:10,fontSize:12,color:'#2d7a6e',maxWidth:500}}}}>
              ✦ Use the <strong>prototype HTML file</strong> for the full Mailing experience.
            </div>
          </div>
        </div>
      </main>
